...
-- companies.php: Line 150
SELECT LocationID FROM Location WHERE City = [city] AND CountryName = [country] AND ContinentName = [continent]

-- companies.php: Line 157
INSERT INTO Location (City, CountryName, ContinentName) VALUES ([city], [country], [continent])

-- companies.php: Line 162
UPDATE Company SET CompanyName = [company_name], TierLevel = [tier_level], Type = [company_type], LocationID = :location WHERE CompanyID = [company_id]

-- companies.php: Lines 206-210
